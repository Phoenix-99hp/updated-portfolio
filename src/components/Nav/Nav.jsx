    ...
    return (
        <StyledNavContainer>
            <StyledNavList extraPadding={extraPadding}>
                <Link to="/About"><StyledNavItem selected={window.location.pathname === "/About" ? true : false}>About</StyledNavItem></Link>
                <Link to="/Portfolio"><StyledNavItem selected={window.location.pathname === "/Portfolio" ? true : false}>Portfolio</StyledNavItem></Link>
